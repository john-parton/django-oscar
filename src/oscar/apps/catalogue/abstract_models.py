...
class AbstractProduct(models.Model):
    ...
    def options(self):
        ...
        It's possible to have options product class-wide, and per product.
        """
        pclass_options = self.product_class.options.all()
...
class AbstractChildProduct(models.Model):
    ...
    parent = models.ForeignKey(
        'catalogue.Product', related_name='children',
        verbose_name=_("Parent product"),
    ...
    def __init__(self, *args, **kwargs):
        super(AbstractChildProduct, self).__init__(*args, **kwargs)
    ...
    def options(self):
        ...
        It's possible to have options product class-wide, and per product.
        """
        pclass_options = self.parent.product_class.options.all()
        return set(pclass_options) or set(self.product_options.all())

    @property
    def is_shipping_required(self):
        return self.parent.product_class.requires_shipping
...
class ProductAttributesContainer(object):
    ...
    def get_all_attributes(self):
        return self.product.parent.product_class.attributes.all()
