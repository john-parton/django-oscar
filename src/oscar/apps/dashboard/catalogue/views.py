...
class ChildProductCreateUpdateView(generic.UpdateView):
    """
...
#     recommendations_formset = ProductRecommendationFormSet
    ...
    def get_queryset(self):
        ...
        """
        return filter_products(ChildProduct.objects.all(), self.request.user)
    ...
    def get_object(self, queryset=None):
        ...
        if self.creating:
            ...
            self.product_class = product.parent.product_class
            return product

    def get_context_data(self, **kwargs):
        ctx = super(ChildProductCreateUpdateView, self).get_context_data(**kwargs)
...
#         ctx['parent'] = self.parent
    ...
    def get_form_kwargs(self):
        kwargs = super(ChildProductCreateUpdateView, self).get_form_kwargs()
